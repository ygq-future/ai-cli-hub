...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      to: { path: '^src/(core|event|transport|cli|runtime|approval|repository|storage|memory)' },
    },
    {
      ...
      to: { path: '^src/(core|event|transport|cli|runtime|approval|repository|memory|config)' },
    },
    {
      ...
      to: { path: '^src/(core|transport|cli|runtime|approval|memory)' },
    },
    {
